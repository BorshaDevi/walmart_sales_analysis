...
<li>First, remove the '$' symbol and then convert the data type from string to float using:
  ...
  <li><strong>Standardize Text Data -</strong>
    <ul>
        ...
        <li>This helps to avoid duplication caused by different text formats (e.g., "Branch" vs "branch").</li>
    </ul>
</li>
</ul>
...
<h3>4. Load Data into PostgreSQL</h3>
<ul>
...
Must be create <code>engine</code>.This is generate with postgreSQL. 
</li>
</ul>

<h3>5. SQL Analysis: Complex Queries and Business Problem Solving</h3>
...
![Walmart Dashboard](graph_visualiser-shift_analysis)
